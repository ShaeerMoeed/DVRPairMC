...
plt.scatter(mc_g, mc_corr_mean, label="MC (P>60)", color="black")
plt.errorbar(mc_g, mc_corr_mean, mc_corr_se, capsize=5, fmt="None", color="black")

mc_corr_mean_copy = list(map(lambda x: x/149, mc_corr_mean_copy))
mc_corr_se_copy = list(map(lambda x: x/149, mc_corr_se_copy))
plt.scatter(mc_g, mc_corr_mean_copy, label="MC (P=60)", color="C0")
...
plt.savefig("Correlation_Poster.png", bbox_inches='tight', dpi=1200)
