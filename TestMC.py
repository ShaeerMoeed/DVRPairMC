...
def prop_n3_SOS_preprocess(l, g):
    ...
    return evals, evecs, corr_vec, potential_vec

def prop_n3_SOS(eigvals, eigstates, corr_vec, pot_vec, T, num_grid_pts):
    ...
    return v_exp, corr_exp

def prop_n3_NMM(l, g, P, T, corr_vec, potential_vec):
...
if __name__ == "__main__":
    ...
    #evals, evecs, corr_vec, potential_vec = prop_n3_SOS_preprocess(l, g)
    #v_exp_sos, corr_exp_sos = prop_n3_SOS(evals, evecs, corr_vec, potential_vec, T, 2*l+1)

    v_3_body = dvr_v_n3(l, g)
    potential_vec = np.diag(v_3_body)
    corr_vec = get_corr_vec(2 * l + 1)
    v_exp_nmm, corr_exp_nmm = prop_n3_NMM(l, g, P, T, corr_vec, potential_vec)
